...
# new args
# parser.add_argument('--use_resnet18_cls_1000_cpt100', default=False, type=bool, help='use resnet18 cls 1000 cpt100')
parser.add_argument('--use_resnet18_cls_1000_cpt100', action='store_true', help='use resnet18 cls 1000 cpt100')
